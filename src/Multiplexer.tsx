 ...
 * prefix-based key bindings, and full-screen support.
 *
 ...
 * };
 *
 * // Full screen tmux-like mode (no borders, no scrolling)
 * <Multiplexer layout={layout} enterFullScreen={true} />
 *
 * // Custom size with borders and custom prefix key
 * <Multiplexer layout={layout} width={100} height={30} showBorders={true} prefixKey="a" />
 *
 * // Enable full screen mode to use alternate screen buffer (prevents scrolling)
 * <Multiplexer layout={layout} enterFullScreen={true} />
 * ```
 */
export const Multiplexer: React.FC<MultiplexerProps> = ({
  ...
  const height = enterFullScreen ? terminalHeight : (propHeight ?? terminalHeight);
  ...
  return (
    <Box flexDirection="column" width={width} height={height}>
      ...
      {/* Ctrl+C indicator */}
      {ctrlCPressed && !showHelpModal && (
        <Box
          width="100%"
          justifyContent="center"
          marginTop={prefixMode ? 0 : -1}
        >
          <Box
            paddingX={1}
            borderStyle="round"
